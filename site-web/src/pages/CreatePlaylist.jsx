...
export default function CreatePlaylist() {
  ...
  const handleSubmit = async (event) => {
    ...
    // DONE : envoyer la bonne requête pour ajouter ou modifier une playlist en fonction de l'attribut params.id
    if (params.id) {
    ...
    <main id="main-area" className="flex-row">
      <form className="form-group" id="playlist-form">
        ...
        <fieldset className="form-control">
          ...
          {/*DONE : construire les choix de chansons dans des éléments <option> */}
